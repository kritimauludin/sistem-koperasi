<!-- resources/views/export/anggota.blade.php -->
<style>
    .text-size-30 {
        font-size: 30px;
    }
...
<div style="text-align: center; margin-top: 20px; ">
    Data Anggota UP2K-PKK / {{ date('d-m-Y') }}
</div>
    ...
    <tbody>
        @foreach ($dataAnggota as $anggota)
            <tr style="font-size: 12px;">
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $anggota->nama }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $anggota->nik }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $anggota->jeniskelamin }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $anggota->tgl }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $anggota->jenis }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $anggota->kategori }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $anggota->alamat }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
