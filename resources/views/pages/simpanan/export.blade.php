...
<div style="text-align: center; margin-top: 20px; ">
    Data Simpanan UP2K-PKK / {{ date('d-m-Y') }}
</div>
...
<table width=100%;
    ...
    <tbody>
        @foreach ($simpanans as $simpanan)
            <tr>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->anggota->nama }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->anggota->kategori }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->anggota->jenis }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->anggota->alamat }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->tgl }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->pokok }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->wajib }}</td>
                <td style="font-size: 12px; text-align:center; paddding:5px">{{ $simpanan->sukarela }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
